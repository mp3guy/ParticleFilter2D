...
// TODO: move the random functions into a separated file?
...
*/
inline float randomFloat() {return float(rand()) / RAND_MAX_FLOAT;}
...
* @return The random number.
*/
inline int random(int n) {return (int)(randomFloat()*n*0.999999);}
